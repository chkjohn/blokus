...
function init_waitingroom(socket){
	...
	$(function(){
		...
		$('#createGameRoom').click(function(){
			$('#createGameRoomTable').css({'display': 'initial', 'height': '300px', 'width': '600px', 'position': 'absolute', 'top': (window.innerHeight - 300)/2 + 'px', 'left': (window.innerWidth - 300)/2 + 'px', 'z-index': 5, 'background': 'white'});
